...
<body class="bg-[#e4eaf2] text-[#1F2937] flex flex-col min-h-screen">
    ...
    <header class="p-3 border-b border-gray-800 flex items-center bg-white mb-auto">
    ...
    <div class="my-auto flex flex-col space-y-3">
        <form action="verify.php" method="post" class="flex justify-center items-center" id="check">
            <input name="password" type="password" autocomplete="new-password" placeholder="••••••••"
                class="bg-white rounded-l-md outline-none border border-[#1F2937] py-2 px-3" minlength="10" required>
            <button type="submit"
